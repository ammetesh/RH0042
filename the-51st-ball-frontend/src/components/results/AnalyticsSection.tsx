    ...
    return (
        ...
        >
            ...
            >
                ...
                <TestsRadar
    entropy={tests.entropy === "PASS" ? 100 : 0}
    runs={tests.runs === "PASS" ? 100 : 0}
    serial={tests.serial === "PASS" ? 100 : 0}
    uniformity={tests.uniformity === "PASS" ? 100 : 0}
    randomness={tests.randomness === "PASS" ? 100 : 0}
/>
            ...
            <TrendChart
    trends={{
        entropy: audit.entropy?.entropy_percentage ?? 0,

        runs: audit.runs?.passed
            ? 100
            : 40,

        serial:
            audit.serial?.classification === "Excellent"
                ? 100
                : audit.serial?.classification === "Moderate"
                ? 60
                : 30,

        uniformity:
            audit.uniformity?.uniformity_score ?? 0,
